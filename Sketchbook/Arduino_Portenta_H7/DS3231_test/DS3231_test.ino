...
void loop() {
  ...
  time_date_stamp = String(myRTC.getYear()) + "=" + String(myRTC.getMonth(century)) + "-" + String(myRTC.getDate()) + "T" +
    String(myRTC.getHour(h12Flag, pmFlag)) + ":" + String(myRTC.getMinute()) + ":" + String(myRTC.getSecond());

  Serial.print("Time Stamp = '");
  Serial.print(time_date_stamp);
  Serial.println("'");
