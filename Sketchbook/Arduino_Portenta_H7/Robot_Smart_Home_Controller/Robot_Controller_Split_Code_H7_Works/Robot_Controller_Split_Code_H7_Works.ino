...
*/
  time_str = left_pad(String(current.hour()), 2) + ":" + left_pad(String(current.minute()), 2) + ":" + left_pad(String(current.second()), 2);
  date_str = left_pad(String(current.year()), 4) + "-" + left_pad(String(current.month()), 2) + "-" + left_pad(String(current.day()), 2);
/*
...
*/
  if (show_full) {
    ...
    week_day_nr = current.dayOfTheWeek();
/*
...
*/
    if (!show_seconds) {
      str_len = time_str.length();
      min_sec_str = min_sec_str.substring(0, str_len - 3);
    }
