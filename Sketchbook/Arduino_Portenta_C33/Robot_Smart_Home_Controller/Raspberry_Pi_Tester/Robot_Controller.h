...
//  For testing Arduino HAT Carrier GPIO
#define LED_RASPI_TEST_PIN        A1        //  GPIO_24
#define SWITCH_RASPI_TEST_PIN     GPIO_26
...
/*
  Switches
*/
#define SWITCH_WHITE_PIN          GPIO_12     //  A0 Works Raspberry Pi 07 (White)
