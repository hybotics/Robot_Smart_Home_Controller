...
/*
  Blink an LED on the selected pin.
*/
void blink_led_33 (uint8_t pin, uint8_t blink_rate_ms=DEFAULT_BLINK_RATE_MS, uint8_t nr_cycles=DEFAULT_NR_CYCLES) {
  uint8_t index;
...
void setup(void) {
  ...
  //  Initialize the Raspberry Pi Pin
